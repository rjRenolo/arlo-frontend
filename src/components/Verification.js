...
const dbStore = new Store('verification-store');
    ...
    return (
      <div className="wrapper">
        ...
        <div className="titleBlock">
          <h1>Verification<br />of identity</h1>
        </div>
        ...
        <div className="row">
          ...
          <div className="g_grid_6">
            ...
            <div className="group">
              ...
              <textarea name="verification1" onChange={this.handleChange} value={this.state.verification1}></textarea>
            </div>
          ...
          <div className="g_grid_6">
            ...
            <div className="group">
              <label>Identity Verified</label>
              <textarea name="verification2" onChange={this.handleChange} value={this.state.verification2}></textarea>
            </div>
        ...
        <div className="group adviserGroup">
          <div className="adviserNotes">
            ...
            <ul>
              ...
              <li>Are the documents current/valid (passport, License; Bills)?</li>
              <li>Have we followed AML procedures?</li>
            </ul>
          </div>
        ...
        <div className="row">
          <div className="group submit">
            <Link to="./prompt" onClick={() => this.saveDetails()}>Save &amp; Continue</Link>
          </div>
