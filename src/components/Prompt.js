...
const dbStore = new Store('prompt-store');
    ...
    return (
      <div className="wrapper">
        ...
        <div className="titleBlock">
          <h1>What prompted you to<br />seek financial advice?</h1>
        </div>

        <div className="group">
          <label>What prompted you to seek financial advice?</label>
          <textarea name="prompt" onChange={this.handleChange} value={this.state.prompt}></textarea>
        </div>
        ...
        <div className="group adviserGroup">
          <div className="adviserNotes">
            ...
            <ul>
              <li>Web search?</li>
              <li>Adviser referral?</li>
              <li>Client is Sophisticated Investor</li>
            </ul>
          </div>
        ...
        <div className="row">
          <div className="group submit">
            <Link to="./objectives" onClick={() => this.saveDetails()}>Save &amp; Continue</Link>
          </div>
